...
import capstonedesign.medicalproduct.dto.mvc.ItemDetailDto;
import capstonedesign.medicalproduct.dto.mvc.RecipientInfo;
import capstonedesign.medicalproduct.dto.mvc.order.OrderDto;
...
public class OrderController {
    ...
    public String itemPayment(@Valid @ModelAttribute("orderDto") OrderDto orderDto, BindingResult bindingResult, Model model){
        ...
        orderService.save(orderDto.getMemberId(), orderDto.getName(), orderDto.getPhoneNumber(),
    ...
    public String orderList(HttpServletRequest request, @ModelAttribute("orderSearch") OrderSearch orderSearch, Model model){
        ...
        List<OrderedItemDto> orderedItems = orderService.findAllOrderItemByMemberIdAndOrderInfo(member.getId(), orderSearch);
    ...
    public String orderDetail(@PathVariable("id") long orderId, Model model){
        ...
        List<OrderedItemDto> orderedItems = orderService.findAllOrderItemById(orderId);
