...
import capstonedesign.medicalproduct.dto.mvc.*;
...
public class MemberController {
    ...
    public String tryIdFind(@Valid @ModelAttribute("idFindForm") IdFindForm idFindForm,
        ...
        Member member = memberService.findByNameAndPhoneNumber(idFindForm);
    ...
    public String tryPasswordFind(@Valid @ModelAttribute("passwordFindForm")
        ...
        Member member = memberService.findByLoginId(passwordFindForm.getLoginId());
