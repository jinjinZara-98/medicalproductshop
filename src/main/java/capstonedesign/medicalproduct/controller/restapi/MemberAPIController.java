...
public class MemberAPIController {
    ...
    public String deleteMember(@Valid @RequestBody MemberRegisterForm form, BindingResult bindingResult) {
        ...
        //아이디 중복체크
        int exsist = memberService.existsByLoginId(form.getLoginId());
    ...
    public List<MemberAPIDto> findAllMembers() {

        List<Member> members = memberRepository.findAll();

        List<MemberAPIDto> result = members.stream()
                .map(member -> new MemberAPIDto(member))
                .collect(toList());
    ...
    public MemberAPIDto findMember(@PathVariable("memberId") long memberId) {
        ...
        MemberAPIDto result = new MemberAPIDto(member);
    ...
    public MemberAPIDto updateMember(@PathVariable("memberId") long memberId,
